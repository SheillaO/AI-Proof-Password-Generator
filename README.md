...
- Research paper: _"LLM Password Generation"_ (Feb 2025)
...
- _"Large Language Models as Password Generators"_ - Stanford Cybersecurity Lab (Feb 2025)
- _"2024 Password Security Report"_ - LastPass
- _"AI Predictability in Cryptographic Applications"_ - MIT CSAIL
